...
public class Shadows
{
    ...
    async void RenderDirectionalShadows()
    {
    ...
    async void RenderDirectionalShadows(int index, int split, int tileSize)
    {
    ...
    async void SetKeywords(string[] keywords, int enabledIndex)
    {
